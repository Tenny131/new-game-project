...
@onready var base_card_scene: PackedScene = preload("res://content/cards/base_cards/view_base_card.tscn")
@onready var spawn_point: Node = $CanvasLayer/CardSpawnPoint
@onready var player_inventory: Inv = preload("res://characters/player/player_inventory.tres")
